...
export function FooterCTA() {
  ...
  return (
    <section id="contact" className="py-24 px-4">
      <div className="max-w-5xl mx-auto rounded-[3rem] bg-primary p-12 md:p-16 text-center space-y-10 overflow-hidden relative shadow-[0_20px_50px_rgba(255,65,54,0.3)]">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black font-headline text-white leading-[1.15] mb-10 max-w-4xl">
          ...
          <div>
            <ContactDialog>
              <Button 
                size="lg" 
                className="rounded-full bg-white text-primary hover:bg-white/90 font-bold px-10 h-14 text-lg shadow-xl transition-all hover:scale-105 active:scale-95 border-none"
              >
                Let’s Chat!
              </Button>
            </ContactDialog>
